 ...
 * Generated at: 2015-03-15 13:19:17 UTC
...
return;
	...
	User user = Database.show(userId.toString());
      ...
      out.write("\t\t\t\t\ttype=\"text\" name=\"userId\" id=\"userId\" placeholder=\"id\"\n");
      out.write("\t\t\t\t\tvalue=\"");
      out.print(user.getUserId());
      out.write("\" readonly required /> <label\n");
      out.write("\t\t\t\t\tid=\"icon\" for=\"email\"><i class=\"icon-envelope \"></i></label> <input\n");
      out.write("\t\t\t\t\ttype=\"text\" name=\"email\" id=\"email\" placeholder=\"E-mail\"\n");
      out.write("\t\t\t\t\tvalue=\"");
      out.print(user.getEmail());
      out.write("\" required /> <label id=\"icon\"\n");
      out.write("\t\t\t\t\tfor=\"Password\"><i class=\"icon-shield\"></i></label> <input\n");
      out.write("\t\t\t\t\ttype=\"password\" name=\"password\" id=\"password\"\n");
      out.write("\t\t\t\t\tplaceholder=\"Password\" required /> <input type=\"submit\"\n");
      out.write("\t\t\t\t\tclass=\"button\" value=\"modify\"></input>\n");
      out.write("\t\t\t</form>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      out.write("\n");
